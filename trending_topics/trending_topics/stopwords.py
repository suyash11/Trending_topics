"""Stopword module for centrally updating stopword list."""

stopword_str = """flag plane face bank a able about above abst accordance years time company people
                  state work government report june share play team include
                  help day month tuesday design monday told percent video move
                  app good thing well sign group plan base launch list according accordingly across
                  act actually added adj affected affecting affects after
                  afterwards again against ah all almost alone along already
                  ...
                  begin beginning beginnings begins behind being believe below
                  beside besides between beyond biol both brief briefly but by
                  c ca came can cannot can't cause causes certain certainly co
                  1 2 3 4 5 6 7 8 9 com come comes contain containing contains
                  ...
                  getting give given gives giving go goes gone got gotten h had
                  happens hardly has hasn't have haven't having he hed hence her
...
def stopwords():
    """Stopword method to return set of unique stopwords."""
